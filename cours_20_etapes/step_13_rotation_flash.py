# Step 13 - Rotation + flash rouge sur degats
# -------------------------------------------------------------------
# OBJECTIF PEDAGOGIQUE:
# - Rendre le feedback visuel plus clair.
# - Introduire l'idee: "etat visuel temporaire" (hit_flash).
#
# NOUVEAUTE:
# - Joueur + monstres tournent selon leur direction.
# - Joueur + monstres clignotent en rouge quand ils sont touches.
#
# NOTE TEMPORAIRE:
...
def draw_player(screen, player):
    ...
    color = COLOR_FLASH if is_flashing(player["hit_flash"]) else COLOR_PLAYER
...
def draw_monsters(screen, monsters):
    for monster in monsters:
        ...
        if monster["type"] == "slime":
            base_color = COLOR_MONSTER
        else:
            base_color = COLOR_MONSTER_2

        color = COLOR_FLASH if is_flashing(monster["hit_flash"]) else base_color
...
pygame.display.set_caption("Step 13 - Rotation + flash")
...
projectiles = []
message = "Rotation + flash rouge quand touche."
...
# ------------------------------------------------------------
# EXERCICE GUIDE - STEP 13 (ROTATION + FLASH)
# ------------------------------------------------------------
# Objectif de l'exercice:
# - Comprendre les retours visuels apres un degat.
#
# Etape 1:
# - Change HIT_FLASH_TIME (ex: 0.35 -> 0.60).
# - Verifie que le flash rouge dure plus longtemps.
#
# Etape 2:
# - Mets HIT_FLASH_TIME a 0.15.
# - Verifie que le flash devient tres court.
#
# Etape 3:
# - Bouge le joueur dans 4 directions et observe la rotation.
# ------------------------------------------------------------
