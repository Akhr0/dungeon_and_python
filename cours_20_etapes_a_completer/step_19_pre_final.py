#
# Step 19 - Pre-final (integration complete)
# -------------------------------------------------------------------
# Cette etape reprend quasiment le jeu final dans un seul fichier.
# Objectif: faire une \"repetition generale\" avant la version finale.
# -------------------------------------------------------------------
#
"""
...
# >>> START CODE ELEVE
            # (Attendu: regle victoire / niveau suivant / game_over)
...
# ------------------------------------------------------------
# EXERCICE GUIDE - STEP 19 (PRE-FINAL)
# ------------------------------------------------------------
# Objectif de l'exercice:
# - Faire une verification complete avant le fichier final.
#
# Check-list guidee:
# 1) Le joueur bouge et ne traverse pas les murs.
# 2) SPACE lance des projectiles visibles.
# 3) E ouvre le coffre seulement si adjacent.
# 4) Tous les monstres morts -> niveau +1.
# 5) Niveau 5 -> 2 monstres ; niveau 10 -> boss.
# 6) ENTER redemarre apres game over / win.
#
# Bonus:
# - Note 1 point d'amelioration de lisibilite que tu voudrais
#   appliquer avant un refactoring en plusieurs fichiers.
# ------------------------------------------------------------
