#
# Step 20 - Jeu final (version du cours)
# -------------------------------------------------------------------
# Version complete: 1 salle, progression niveau, murs aleatoires,
# coffres, projectiles, IA simple, boss, game states.
# -------------------------------------------------------------------
#
"""
...
# ------------------------------------------------------------
# EXERCICE GUIDE - STEP 20 (JEU FINAL)
# ------------------------------------------------------------
# Objectif de l'exercice:
# - Tester le jeu final de bout en bout.
#
# Check-list guidee:
# 1) Jouer jusqu'au niveau 5: verifier 2 monstres.
# 2) Jouer jusqu'au niveau 10: verifier le boss.
# 3) Verifier que chaque nouveau niveau regenere murs + coffre.
# 4) Verifier les etats de fin: victoire et defaite.
#
# Mini-defi (facultatif, tres guide):
# - Change UNE constante d'equilibrage seulement:
#   ex: PLAYER_ATTACK_DELAY ou MONSTER_ATTACK_DELAY.
# - Joue 2 minutes et note si le jeu devient trop facile ou trop dur.
# ------------------------------------------------------------
