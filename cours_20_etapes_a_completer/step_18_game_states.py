# Step 18 - Game States (Play / Game Over / Win)
# -------------------------------------------------------------------
# OBJECTIF PEDAGOGIQUE:
# - Introduire un \"etat de jeu\" simple.
# - Avoir un vrai ecran de victoire et de defaite.
#
# NOUVEAUTE:
# - game_state = \"play\", \"game_over\" ou \"win\"
# - ENTER redemarre une partie depuis le debut.
#
# NOTE TEMPORAIRE:
...
def draw_center_text(screen, font, text):
    # Ecran plein simple avec texte au centre.
...
pygame.display.set_caption("Step 18 - Game States")
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if game_state == "play":
                ...
                # ENTER -> restart complet depuis le niveau 1
    ...
    if game_state == "play":
        ...
        # Si tous les monstres sont morts -> progression
        # ============================================================
# >>>>>>>>>>>>>> ZONE A COMPLETER PAR L'ELEVE >>>>>>>>>>>>>>>
# >>> Ecris ton code ENTRE les deux balises START / END
# >>> START CODE ELEVE
        # (Attendu: progression vers win / niveau suivant + passage game_over si hp <= 0)
...
# ============================================================
    ...
    if game_state == "play":
        ...
        draw_center_text(screen, big_font, "Game Over - ENTER pour rejouer")
    elif game_state == "win":
...
# ------------------------------------------------------------
# EXERCICE GUIDE - STEP 18 (GAME STATES)
# ------------------------------------------------------------
# Objectif de l'exercice:
# - Comprendre les etats "play", "game_over", "win".
#
# Etape 1:
# - Perds volontairement (PV a 0) et observe "game_over".
#
# Etape 2:
# - Appuie sur ENTER pour relancer une nouvelle partie.
# - Verifie que le niveau revient au debut.
#
# Etape 3:
# - Modifie le texte affiche dans draw_center_text
#   pour personnaliser l'ecran de victoire.
# ------------------------------------------------------------
