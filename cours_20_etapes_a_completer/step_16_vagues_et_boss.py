...
# - Ajouter les regles de difficultes demandees.
# - Garder la progression par niveaux.
#
# NOUVEAUTE:
# - Niveau 1 a 4: 1 monstre par vague.
# - Niveau 5 a 9: 2 monstres par vague.
# - Niveau 10: boss.
# - Plus le niveau monte, plus les monstres sont rapides.
#
# NOTE TEMPORAIRE:
...
# >>> START CODE ELEVE
    # (Attendu: regle de vague selon level: 1 monstre, 2 monstres, ou boss)
...
pygame.display.set_caption("Step 16 - Vagues + Boss")
...
# ------------------------------------------------------------
# EXERCICE GUIDE - STEP 16 (VAGUES + BOSS)
# ------------------------------------------------------------
# Objectif de l'exercice:
# - Comprendre les paliers de difficulte.
#
# Etape 1:
# - Verifie la regle: niveau 1-4 = 1 monstre.
# - Puis niveau 5-9 = 2 monstres.
#
# Etape 2:
# - Verifie qu'au niveau 10, le boss apparait.
#
# Etape 3:
# - Change temporairement le palier 5 en palier 3
#   dans la fonction de spawn, puis teste.
# - Remets ensuite la valeur initiale.
# ------------------------------------------------------------
